...
const HowItWorks = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-cyan-50 via-white to-blue-50" id="como-funciona">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          <div className="hidden lg:block absolute top-24 left-0 right-0 h-0.5 bg-gradient-to-r from-cyan-200 via-cyan-400 to-cyan-200 -z-10" />
          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative"
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-cyan-100 h-full">
                  {/* Number badge */}
                ...
                {/* Connector dot */}
                {/* <div className="hidden lg:block absolute top-24 -translate-y-1/2 left-1/2 -translate-x-1/2 w-4 h-4 bg-cyan-500 rounded-full border-4 border-white shadow-md z-10" /> */}
              </motion.div>
            );
          })}
        </div>
        ...
        <motion.div
          ...
          className="mt-16 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-3xl p-8 md:p-12 text-white shadow-2xl"
        >
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold mb-2">Conforto</div>
              <div className="text-cyan-100">Atendimento na sua casa</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">Flexibilidade</div>
              <div className="text-cyan-100">Horários adaptados</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">Personalização</div>
              <div className="text-cyan-100">Tratamento exclusivo</div>
            </div>
          </div>
        </motion.div>
      </div>
